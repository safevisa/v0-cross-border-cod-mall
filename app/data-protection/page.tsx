              ...
              <Card>
                ...
                <CardContent className="prose prose-sm max-w-none">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="mb-4">
                      ICEBOX NETWORK SL processes personal data in compliance with the General Data Protection Regulation (GDPR) and Spanish data protection laws. Our legal bases for processing include:
                    </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <p><strong>Supervisory Authority:</strong> Spanish Data Protection Agency (AEPD)</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
