...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full p-2 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 flex justify-center">
      <div className="container flex h-16 flex-wrap items-center justify-between"> 
